<?php
/**
 * Plugin Name: WP Editor Boxes Add-on
 * Plugin URI: https://wp-editor.com
 * Description: Power Up WordPress Visual Editor With Info Boxes
 * Version: 0.1.1
...
class WPE_Addon_Boxes{
	...
	public function updater_setup(){
		...
		$config = array(
			...
			'repo_slug' => 'wpe-boxes-add-on',  //required
		);

		/* Load Updater Class */
		new WPE_Boxes_Plugin_Updater( $config );
	}
}
